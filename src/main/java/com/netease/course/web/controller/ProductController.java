...
public class ProductController extends BaseController {
	...
	public String list(HttpSession session, HttpServletRequest request, QuerryInfo querryInfo, Model model) {
		// 查找所有商品分页数据
		PageBean<Product> pageBean = productService.getPage(querryInfo);
		// 添加商品数据回显
